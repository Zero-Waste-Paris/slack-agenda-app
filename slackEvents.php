...
class SlackEvents {
    ...
    protected function render_event($parsed_event, $description=false) {
        ...
        $infos .= "*Liste des participants " . format_number_of_attendees($parsed_event["attendees"], $parsed_event["participant_number"], $parsed_event["unknown_attendees"])."*: " . format_userids($parsed_event["attendees"], $parsed_event["unknown_attendees"]);
